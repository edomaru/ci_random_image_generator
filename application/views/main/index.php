		...
		<div class="panel panel-default">
			...
			<div class="panel-body">						
				<?php echo form_open("", array("class" => "form-horizontal")) ?>				
					...
					<div class="form-group">
						<label for="text" class="col-md-3 col-xs-3">Image Text</label>
						<div class="col-md-9 col-xs-9">
							<input type="text" name="image_text" value="" id="image_text" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label for="image_count" class="col-md-3 col-xs-3">How many?</label>
						<div class="col-md-3 col-xs-3">
					...
					<div class="form-group">
						<label for="image_count" class="col-md-3 col-xs-3">Provider</label>
